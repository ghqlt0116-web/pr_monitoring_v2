...
2. **여론/감정 왜곡 절대 금지**: 시청자가 기술적 한계(예: 구축 아파트 인프라 한계)를 단순히 언급하거나 오히려 국내 통신사/제조사를 옹호하는 내용임에도 불구하고, 이를 "통신사에 대한 불만이나 비판"으로 과장하여 해석하지 마세요. 문맥의 실제 뉘앙스(중립, 옹호, 단순 사실 나열)를 정확하고 객관적으로 반영하세요.
3. 출력 양식 엄수: 대상 영상이 당사와 관련이 깊든, 전혀 무관한 단순 유머/기기 리뷰든 상관없이 **무조건 아래 3가지 카테고리(■) 양식을 예외 없이 고정하여 작성하세요.**
